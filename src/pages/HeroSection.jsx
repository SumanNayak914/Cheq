...
const HeroSection = () => {
  return (
    <section className="relative overflow-hidden bg-gradient-to-b from-green-100 via-white to-white">
      ...
      /> */}
      {/* Floating Coins */}
<FloatingCoin className="w-28 sm:w-32 md:w-36 top-32 left-1/4 md:left-[9%]" delay={0.2} />
<FloatingCoin className="w-32 sm:w-36 md:w-40 top-20 right-1/6" delay={0.8} />
<FloatingCoin className="w-24 sm:w-28 md:w-32 bottom-20 left-1/4" delay={1.0} />
<FloatingCoin className="w-28 sm:w-32 md:w-36 bottom-10 right-10" delay={1.2} />
